...
function init(){
    ...
    // Rooms
    let room = createRoom(new THREE.Vector3(0,0,0), LENGTH_ROOM, HEIGHT_ROOM, BREADTH_ROOM);
    scene.add(room);
    let room2 = createRoom(new THREE.Vector3(LENGTH_ROOM,0,0), LENGTH_ROOM, HEIGHT_ROOM, BREADTH_ROOM);
    scene.add(room2);
...
socket.on('eventDetails', function(event){
    ...
    LENGTH_HALL = LENGTH_ROOM * NUM_ROOMS;
    BREADTH_HALL = (BREADTH_ROOM * NUM_ROOMS * 2) + BREADTH_CORRIDOR;
